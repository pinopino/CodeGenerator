...
namespace Generator.Core
{
    ...
    public abstract class BaseGenerator_DAL : BaseGenerator
    {
        ...
        #region Exists
        public abstract string Get_Exists(TableMetaData table);
        #endregion

        #region Insert
        public abstract string Get_Insert(TableMetaData table);
        #endregion

        #region Delete
        public abstract string Get_Delete(TableMetaData table);
        #endregion

        #region BatchDelete
        public abstract string Get_BatchDelete(TableMetaData table);
        #endregion

        #region Update
        public abstract string Get_Update(TableMetaData table);
        #endregion

        #region Select
        public abstract string Get_GetModel(TableMetaData table);
        public abstract string Get_GetList(TableMetaData table);
        #endregion

        #region Page
        public abstract string Get_Count(TableMetaData table);
        public abstract string Get_GetListByPage(TableMetaData table);
        #endregion

        #region Joined
        public abstract string Get_Joined(JoinMapping join_info);
        #endregion

        #region tail
        public string Get_Tail(TableMetaData table)
        {
